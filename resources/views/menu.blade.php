...
$model = new \App\Models\M_projek();
$user = $model->getWhere('tb_user', ['id_user' => $id_user]);

// Define the path to the user's photo
$photoPath = 'img/avatar/' . $user->foto;
...
if (!empty($user->foto) && file_exists($photoPath)) {
    ...
    $profilePhoto = "{{asset  ('img/avatar/user.png')}}"; // Default photo
}
?>
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
       ...
       $foto_profil = ($user->foto) ? asset('img/avatar/' . $user->foto) : asset('img/avatar/user.png');
        ...
        <div class="d-sm-none d-lg-inline-block">Hi, {{ e($user->username) }}</div>
        </a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <img src="{{ asset('img/avatar/' . $setting->logo_dashboard) }}" class="logo-dashboard" width="215px">
      <a href="{{ url('home/dashboard') }}">{{ $setting->nama_web }}</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">SPH</a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
            <li class="dropdown active">
              <a href="{{url  ('home/dashboard') }}" ><i class="fas fa-fire"></i><span>Dashboard</span></a>
            ...
            <!-- <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Absensi</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{url  ('home/absensi') }}">View Data</a></li>
                <li><a class="nav-link" href="{{url  ('home/t_absensi') }}">Input Data</a></li>
              </ul>
            </li> -->

            <li><a class="nav-link" href="{{url  ('home/absensi') }}"><i class="far fa-square"></i> <span>Absensi</span></a></li>

            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Jadwal</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{url  ('home/jadwal') }}">View Data</a></li>
                <li><a class="nav-link" href="{{url  ('home/t_jadwal') }}">Input Data</a></li>
              </ul>
            </li>
            
            <li><a class="nav-link" href="{{asset  ('home/blok') }}"><i class="far fa-square"></i> <span>Blok</span></a></li>
            <li><a class="nav-link" href="{{asset  ('home/kelas') }}"><i class="far fa-square"></i> <span>Kelas</span></a></li>
            <li><a class="nav-link" href="{{asset  ('home/mapel') }}"><i class="far fa-square"></i> <span>Mapel</span></a></li>
            <li><a class="nav-link" href="{{asset  ('home/user') }}"><i class="far fa-square"></i> <span>User</span></a></li>
